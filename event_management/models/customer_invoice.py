...
class AccountMoveLine(models.Model):
    ...
    fortuna_discount = fields.Float(force_save=True)
    ...
    @api.model
    def _get_fields_onchange_balance_model(self, quantity, discount, advance, fortuna_discount, amount_currency, move_type, currency, taxes, price_subtotal, force_computation=False):
    ...
    def create(self, vals_list):
        ...
        BUSINESS_FIELDS = ('price_unit', 'quantity', 'discount', 'tax_ids','fortuna_discount')
